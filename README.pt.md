...
- Site: **https://openrepos.org/** — os outros seis domínios redirecionam para cá
...
A URL de status sempre usa `openrepos.org`; substitua `awesome-project` pelo seu subdomínio e use o domínio reivindicado no link.
