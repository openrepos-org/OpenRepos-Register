...
العملية الكاملة — قواعد المحتوى والمراجعة والإزالة والاعتراضات — وسياسة الأسماء المحجوزة
موثقة على **https://openrepos.org/abuse**. الأسماء المحجوزة (انظر
[`reserved.json`](./reserved.json)) تحمي البنية التحتية وتمنع انتحال الهوية، وتُدرس طلبات
الإتاحة حالة بحالة.
